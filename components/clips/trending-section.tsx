...
export function TrendingSection({ className }: TrendingSectionProps) {
  const { data: clips, isLoading, error } = useHomepageTrending(6)
 ...
 */
export function TrendingSectionServer({ className }: TrendingSectionProps) {
  return <TrendingSection className={className} />
}
