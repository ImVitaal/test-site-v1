...
import { FeaturedAnimator, RisingStars, RecentAdditions } from '@/components/home'
...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      ...
      {/* Two-Column Section: Rising Stars + Recent Additions */}
      <section className="py-12 md:py-16 border-t border-border">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            {/* Rising Stars */}
            <RisingStars className="py-0" />

            {/* Recent Additions */}
            <RecentAdditions className="py-0" />
          </div>
        </div>
      </section>
